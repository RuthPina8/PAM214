...
export default function ScrollScreen(){
  ...
  const [refreshing, setRefreshing] = useState(false); // Nos sirve para controlar el estado de carga y saber si esta refrescando o no
  const onRefresh = () => {
  setRefreshing(true);
  setTimeout(() => {
    setRefreshing(false);
    ...
    return (
      ...
      <ScrollView // llamada al componente srollview
      ...
      refreshControl = {
        <RefreshControl refreshing ={refreshing} onRefresh={onRefresh} />
            ...
            stickyHeaderIndices={[0]} // sirve para fijar elementos en la parte superior
